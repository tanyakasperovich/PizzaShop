...
struct FavoritePosition: Codable {
    let id: String
    let title: String
    let isPopular: Bool
}
...
struct DBUser: Codable {
    ...
    let favoritePosition: FavoritePosition?
    ...
    init(
        ...
        favoritePosition: FavoritePosition? = nil,
...
//    }
    ...
    init(from decoder: Decoder) throws {
        ...
        self.favoritePosition = try container.decodeIfPresent(FavoritePosition.self, forKey: .favoritePosition)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.favoritePosition, forKey: .favoritePosition)
...
//    }
    ...
    func addFavoritePosition(userId: String, position: FavoritePosition) async throws {
        guard let data = try? encoder.encode(position) else {
            throw URLError(.badURL)
        }
        
        let dict: [String:Any] = [
            DBUser.CodingKeys.favoritePosition.rawValue : data
        ]

        try await userDocument(userId: userId).updateData(dict)
    }
    
    func removeFavoritePosition(userId: String) async throws {
        let data: [String:Any?] = [
            DBUser.CodingKeys.favoritePosition.rawValue : nil
        ]
